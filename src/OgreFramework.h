    ...
    OIS::KeyListener, OIS::MouseListener
{
 ...
 private:
    ...
    Ogre::Root         *m_root;     //< Główny obiekt silnika OGRE
    Ogre::RenderWindow *m_window;   //< Obiekt okna na którym rysowana jest scena
    Ogre::Viewport     *m_viewport; //< Obszar w którym wyświetlana będzie scena
    Ogre::Log          *m_log;      //< Logger
    Ogre::Timer        *m_timer;    //< Zegar
